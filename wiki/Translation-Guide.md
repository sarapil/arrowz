...
```bash
bench --site dev.localhost get-untranslated ar --app arrowz
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `arrowz/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app arrowz | wc -l
```
...
2. Edit/create the CSV file in `arrowz/translations/`
