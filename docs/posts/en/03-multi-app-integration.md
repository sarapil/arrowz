...
# 🔗 Arrowz + ERPNext Ecosystem: Better Together

> **How Arrowz integrates with ERPNext and other Arkan Lab apps to create a complete business solution**

---

## The Power of Integration

Arrowz doesn't work in isolation. It's designed to be part of a **connected ecosystem**:

- **ERPNext CRM** — seamless data flow and shared workflows
- **Vertex Construction** — seamless data flow and shared workflows
- **Velara Hotel** — seamless data flow and shared workflows
- **AuraCRM** — seamless data flow and shared workflows
...
4. **Project started** with full tracking (Arrowz manages the details)
...
# Install all
bench --site your-site install-app caps frappe_visual arkan_help arrowz arrowz
```
