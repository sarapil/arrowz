"""
Arrowz — Demo Data
Load/clear demo data for Arrowz showcases.
...
def load_demo_data():
    """Load demonstration data for Arrowz.
    ...
    try:
        ...
        frappe.db.commit()
        frappe.msgprint(_("Demo data loaded for Arrowz"))
    finally:
...
def clear_demo_data():
    ...
    frappe.db.commit()
    frappe.msgprint(_("Demo data cleared for Arrowz"))
